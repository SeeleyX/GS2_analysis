...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python plot_param.py <folder_name> <param_type>")
        print("Example: python plot_param.py Inputs/ITG_kyscan tri")
        print("Example: python plot_param.py Inputs/ITG_kyscan kappa")
        sys.exit(1)
